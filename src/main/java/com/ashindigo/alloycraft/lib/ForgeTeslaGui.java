...
public class ForgeTeslaGui extends GuiContainer {
	
	public ResourceLocation texture = new ResourceLocation(AlloycraftMain.modid + ":" + "textures/gui/GuiAlloyFurnace.png");
	public ForgeTeslaTileEntity AlloyFurnace;

	public ForgeTeslaGui(InventoryPlayer invPlayer, ForgeTeslaTileEntity teAlloyFurnace) {
		super(new ForgeTeslaContainer(invPlayer, teAlloyFurnace));
