											...
											if(invCraft.getStackInSlot(6).getItem() == AlloycraftItems.alloy) {
												if(invCraft.getStackInSlot(7).getItem() == AlloycraftItems.alloy) {
													if(invCraft.getStackInSlot(8).getItem() == AlloycraftItems.alloy) {		
														...
														int prop1 = (int) Math.sqrt(alloy1.getTagCompound().getInteger("Strength") + alloy2.getTagCompound().getInteger("Strength") + alloy3.getTagCompound().getInteger("Strength") + alloy4.getTagCompound().getInteger("Strength") + alloy5.getTagCompound().getInteger("Strength")  + alloy6.getTagCompound().getInteger("Strength") + alloy7.getTagCompound().getInteger("Strength") + alloy8.getTagCompound().getInteger("Strength"));
														int prop2 = (int) Math.sqrt(alloy1.getTagCompound().getInteger("Durability") + alloy2.getTagCompound().getInteger("Durability") + alloy3.getTagCompound().getInteger("Durability") + alloy4.getTagCompound().getInteger("Durability") + alloy5.getTagCompound().getInteger("Durability") + alloy6.getTagCompound().getInteger("Durability") + alloy7.getTagCompound().getInteger("Durability") + alloy8.getTagCompound().getInteger("Durability"));
														int prop3 = (int) Math.sqrt(alloy1.getTagCompound().getInteger("Enchantability") + alloy2.getTagCompound().getInteger("Enchantability") + alloy3.getTagCompound().getInteger("Enchantability") + alloy4.getTagCompound().getInteger("Enchantability") + alloy5.getTagCompound().getInteger("Enchantability") + alloy6.getTagCompound().getInteger("Enchantability") + alloy7.getTagCompound().getInteger("Enchantability") + alloy8.getTagCompound().getInteger("Enchantability"));
